// ============================================================================
// Cliente mínimo do Resend (API de e-mail transacional) -- reaproveita a
// mesma conta/chave já usada no projeto Vendas Externas.
//
...
const FROM_ADDRESS = "Mental Madness <naotresponda@m3ntalmadness.com>";
